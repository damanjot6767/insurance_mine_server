...
const fs_service_1 = require("../../utils/fs-service");
const processXlsx = async (filePath) => {
    try {
        ...
        await (0, fs_service_1.removeFile)(filePath);
...
const processCsv = (filePath) => {
    ...
    readStream
        ...
        try {
            if (!csvData.length) {
                worker_threads_1.parentPort?.postMessage({ status: "error", message: "Data not found" });
            }
